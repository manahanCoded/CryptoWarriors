          ...
          <div className="w-full flex md:flex-row flex-wrap justify-center items-center lg:gap-8 gap-2">
            ...
            <section className="xl:w-72 lg:w-52 md:w-48 w-56  flex flex-col justify-center items-center gap-1 bg-gray-100">
              ...
              <div className="p-4">
                ...
                <p className="lg:text-base text-xs line-clamp-4 text-gray-800">
                  "I’ve tried a few platforms to understand blockchain, but this
                  one is by far the most engaging! The courses mix theory with
                  practical exercises that walk you through real-world Web3
                  scenarios, like creating smart contracts or understanding
                  decentralized finance. It’s very beginner-friendly but still
                  goes in-depth for more advanced learners. Plus, the
                  certification at the end adds value to my resume!"
                </p>
              </div>
            </section>
            ...
            <section className="xl:w-72 lg:w-52 md:w-48 w-56  flex flex-col justify-center items-center gap-1 bg-gray-100">
              <div className="p-4">
                ...
                <p className="lg:text-base text-xs line-clamp-4 text-gray-800">
                  "This website makes learning Web3 tech straightforward and
                  exciting! The content is very well organized, covering both
                  foundational concepts and advanced topics like DeFi and NFTs.
                  Plus, they’re always updating with the latest trends and
                  tools, which is amazing in such a fast-evolving field. Highly
                  recommended for anyone looking to upskill in Web3!"
                </p>
              </div>
              <img
                className=""
